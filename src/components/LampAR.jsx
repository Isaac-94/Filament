  ...
  return (
    ...
    >
      ...
      >
        ...
        <a-entity
          position="0 -0.5 0" // Ajusta la posición del modelo en relación con la superficie
          rotation="0 0 0" // Ajusta la rotación del modelo si es necesario
        />
      </a-entity>
      ...
      {/* Luz ambiental para mejorar la visualización del modelo */}
